...
export const Discover = () => {
  return (
    <footer className="flex flex-col gap-2 justify-center items-center font-body">
      <h2 className="text-xs uppercase tracking-widest text-stone-500 sm:text-md 2xl:text-sm">
      ...
      >
        <h1 className="text-2xl uppercase tracking-widest text-stone-500 sm:text-4xl 2xl:text-[38px]">
