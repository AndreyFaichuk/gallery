...
import { CheckIcon, Cross, EyeOffIcon, SearchIcon, X } from 'lucide-react';
...
const CommandInput = ({ className, ...props }: ComponentProps<typeof CommandPrimitive.Input>) => {
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0 h-fit">
      <InputGroup className="rounded-lg! border-input/30 bg-input/30 shadow-none! *:data-[slot=input-group-addon]:pl-2! h-fit">
        ...
        {props.value && (
          <InputGroupAddon align="inline-end">
            <X className="size-4 shrink-0 opacity-50" onClick={() => props.onValueChange?.('')} />
          </InputGroupAddon>
        )}
      </InputGroup>
    </div>
